...
export const genres = [
  ...
  "Mystère", "Psychologique", "Historique", "Sports"
];
...
export const allManga: Manga[] = [
  {
    ...
    description: "Tanjiro Kamado et sa sœur Nezuko sont les seuls survivants d'une attaque où leur famille a été massacrée par un démon. Nezuko est devenue un démon, mais a étonnamment conservé une conscience humaine. Tanjiro décide de devenir un Pourfendeur de démons pour venger sa famille et guérir sa sœur.",
  ...
  },
  {
    ...
    title: "One Piece",
    author: "Eiichiro Oda",
    description: "Monkey D. Luffy rêve de retrouver le trésor légendaire, le 'One Piece', laissé par le roi des pirates, Gol D. Roger, et de devenir ainsi le nouveau roi des pirates. Avec son équipage, il parcourt Grand Line, l'océan le plus dangereux du monde.",
  ...
  },
  {
    ...
    author: "Gege Akutami",
    description: "Yuji Itadori, lycéen doté d'une force surhumaine, rejoint une organisation secrète de sorciers pour éliminer une malédiction puissante après avoir mangé un doigt maudit pour sauver ses amis.",
  ...
  },
  {
    ...
    description: "Dans un monde où l'humanité vit entourée de murs pour se protéger de Titans mangeurs d'hommes, Eren Yeager jure de se venger après que sa ville natale ait été détruite et sa mère tuée.",
  ...
  },
  {
    ...
    description: "Denji est un jeune homme pauvre qui chasse des démons avec son démon de compagnie Pochita pour rembourser ses dettes. Suite à une trahison, il fusionne avec Pochita et devient Chainsaw Man.",
  ...
  },
  {
    ...
    description: "Dans un monde où 80% de la population possède un super-pouvoir appelé 'Alter', Izuku Midoriya, né sans pouvoir, rêve de devenir un héros. Sa rencontre avec All Might, le plus grand des héros, changera son destin.",
  ...
  },
  {
    ...
    title: "Spy x Family",
    author: "Tatsuya Endo",
    description: "Un espion, un assassin et une télépathe forment une famille improvisée tout en gardant leurs identités secrètes les uns des autres, pour accomplir une mission qui pourrait préserver la paix mondiale.",
  ...
  },
  {
    ...
    title: "Tokyo Ghoul",
    author: "Sui Ishida",
    description: "Ken Kaneki devient mi-humain mi-goule après une rencontre fatidique, et doit apprendre à s'adapter à sa nouvelle vie tout en étant pris dans un conflit entre le monde des goules et celui des humains.",
  ...
  },
  {
    ...
    description: "Naruto Uzumaki, un jeune ninja hyperactif, rêve de devenir Hokage, le plus puissant ninja et leader de son village. Il est en quête de reconnaissance et doit affronter de nombreux ennemis.",
  ...
  },
  {
    ...
    description: "Son Goku, un combattant exceptionnel, et ses amis partent à la recherche des Dragon Balls, sept boules de cristal qui, une fois réunies, permettent d'invoquer un dragon capable d'exaucer n'importe quel souhait.",
...
export const getMangaChapter = (mangaId: string, chapterNumber: string): ChapterData | undefined => {
