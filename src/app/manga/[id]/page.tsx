...
const MANGA_DETAIL = {
  ...
  description: "One Piece là câu chuyện về Monkey D. Luffy, một cậu bé có ước mơ trở thành Vua Hải Tặc và tìm kiếm kho báu One Piece. Luffy và băng hải tặc của mình, băng Mũ Rơm, phiêu lưu trên Grand Line, đối mặt với nhiều thử thách, kẻ thù và những cuộc phiêu lưu bất tận.",
  ...
  chapters: [
    ...
    { number: "1109", title: "Hải tặc và Thủy quân lục chiến", releaseDate: "2023-05-20" },
    ...
    { number: "1103", title: "Con đường đến Laugh Tale", releaseDate: "2023-04-08" },
  ]
};
